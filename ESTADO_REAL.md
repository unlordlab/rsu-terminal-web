...
| ❌ | 25 | 🟡 | Los umbrales del selector (40/60/80) quedaron descalibrados tras unificar el score en #6 | ABIERTO 01/08, **efecto conocido y medido del arreglo de #6, no un fallo aparte**. Al pasar a crédito parcial, el score medio sube de 25,2 a 43,3, así que los mismos umbrales seleccionan mucho más: con el filtro **por defecto («60 — Estándar») los candidatos pasan de 58 a 148**; con «40 — Amplio», de 159 a 297; con «80 — Estricto», de 12 a 33. No sale ninguno de los que ya estaban — solo entran más. Las etiquetas Amplio/Estándar/Estricto dejan de describir lo que hacen: «Estándar» ya no devuelve una lista corta. **No se recalibra sobre la marcha a propósito**: elegir números nuevos sin criterio sería inventar una calibración, que es justo lo que este proyecto evita. Es una decisión de producto con los datos delante. El impacto visible está acotado porque el frontend ya recorta a 50 filas; lo que cambia de verdad es el contador de candidatos y cuáles son esos 50 |
