const TEAM = [
    ...
    },
    {
        ...
        rol: 'Sin asignar',
        icon: '🕐',
        bio: 'De momento observa, aprende, y cobra en píxeles. Su función exacta todavía se está decidiendo — podría acabar siendo la que le lleve la contraria a Gael, la que vigile que nada falle en silencio, o algo que todavía nadie ha pensado.',
        estado: 'A LA ESPERA',
        estadoColor: '#e0b13e',
    },
];
