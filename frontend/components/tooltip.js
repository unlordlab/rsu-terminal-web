...
Una cartera con 5 sectores al 20% cada uno tiene HHI = 20% (bien repartida). Una cartera con un sector al 60% y el resto repartido tiene un HHI mucho más alto, aunque el "Exposición por Sector" solo muestre ese 60% como dato individual.`
    ...
    "cartera-evolucion": {
        title: "Patrimonio y capital desplegado",
        short: "Dos líneas que crecen no significan que estés ganando: una es lo que vale la cartera, la otra es cuánto capital han llegado a ocupar tus operaciones — que no es lo mismo que dinero aportado.",
...
▸ QUÉ ES EXACTAMENTE LA SEGUNDA LÍNEA

Es el capital DESPLEGADO acumulado: la suma de lo que ha ocupado cada operación abierta alguna vez. No es dinero nuevo que hayas aportado. Si inviertes 5.000, cierras y vuelves a invertir esos mismos 5.000 en otra cosa, esta línea cuenta 10.000 — porque han sido dos operaciones de 5.000, aunque el dinero fuera siempre el mismo.

Por eso NO sirve como denominador de una rentabilidad: dividir el patrimonio entre ella da un porcentaje que baja cuanto más rotas la cartera, aunque ganes lo mismo. Hasta el 4 de agosto de 2026 aquí se enseñaba ese porcentaje y contradecía al resto de la pantalla. La rentabilidad de verdad es la de arriba, ponderada por tiempo.
